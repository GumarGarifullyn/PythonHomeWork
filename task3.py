...
# Напишите программу, которая будет это делать или
# сообщать, что без дополнительной информации это сделать невозможно.

i = int(input("Введите номер вагона, в который сел Витя: "))
j = int(input("Введите номер вагона, который указан у Вити на билете: "))
if i!=j:
    print(f"В поезде {i+j-1} вагонов")
else:
    print("Не возможно узнать общего количества вагонов в поезде")
